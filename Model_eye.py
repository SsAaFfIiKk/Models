...
if __name__ == "__main__":
    ...
    paths_to_images = [os.path.join(path_to_dataset, name) for name in os.listdir(path_to_dataset) if name.endswith('.jpg')]
    ...
    for epoch_idx in range(epoch_num):
        ...
        with torch.no_grad():
            ...
            if best_loss < test_loss:
                torch.save(cnn, "D:/Python/Models/eye/eye_best_" +
                           "epoh_{}, loss_{}, correct_{}".format(epoch_idx, test_loss, test_correct) + ".pth")
                best_loss = test_loss
